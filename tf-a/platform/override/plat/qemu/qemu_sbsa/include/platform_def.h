 ...
 * RMM.
 */
#define NS_DRAM0_BASE (PLAT_QEMU_DRAM0_BASE + NS_DRAM0_BASE_OFFSET)
...
#define PLAT_QEMU_HOLD_SIZE (PLATFORM_CORE_COUNT * PLAT_QEMU_HOLD_ENTRY_SIZE)
...
#define BL1_RW_LIMIT (BL_RAM_BASE + BL_RAM_SIZE - RME_GPT_DRAM_SIZE)
...
#define BL31_LIMIT \
	(BL1_RW_BASE - FW_HANDOFF_SIZE - TB_FW_CONFIG_SIZE - TOS_FW_CONFIG_SIZE)
...
#define BL32_MEM_SIZE                                                        \
	(BL_RAM_SIZE - RME_GPT_DRAM_SIZE - BL1_SIZE - BL2_SIZE - BL31_SIZE - \
	 FW_HANDOFF_SIZE - TB_FW_CONFIG_SIZE - TOS_FW_CONFIG_SIZE)
...
#define QEMU_SP_IMAGE_MMAP                                                \
	MAP_REGION_FLAT(PLAT_QEMU_SP_IMAGE_BASE, PLAT_QEMU_SP_IMAGE_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#elif IMAGE_BL31
/* All SPM Payload memory is marked as code in S-EL0 */
#define QEMU_SP_IMAGE_MMAP                                                  \
	MAP_REGION2(PLAT_QEMU_SP_IMAGE_BASE, PLAT_QEMU_SP_IMAGE_BASE,       \
		    PLAT_QEMU_SP_IMAGE_SIZE, MT_CODE | MT_SECURE | MT_USER, \
		    PAGE_SIZE)
#endif
...
#define PLAT_SPM_BUF_SIZE (PLATFORM_CORE_COUNT * PLAT_SPM_BUF_PCPU_SIZE)
#define PLAT_SPM_BUF_BASE (BL32_LIMIT - PLAT_SPM_BUF_SIZE)

#define QEMU_SPM_BUF_EL3_MMAP                                 \
	MAP_REGION_FLAT(PLAT_SPM_BUF_BASE, PLAT_SPM_BUF_SIZE, \
			MT_RW_DATA | MT_SECURE)

#define QEMU_SPM_BUF_EL0_MMAP                                                \
	MAP_REGION2(PLAT_SPM_BUF_BASE, PLAT_SPM_BUF_BASE, PLAT_SPM_BUF_SIZE, \
		    MT_RO_DATA | MT_SECURE | MT_USER, PAGE_SIZE)
 ...
 */
#define PLAT_QEMU_SP_IMAGE_NS_BUF_BASE \
	(PLAT_QEMU_DT_BASE + PLAT_QEMU_DT_MAX_SIZE)
#define PLAT_QEMU_SP_IMAGE_NS_BUF_SIZE ULL(0x200000)

#define QEMU_SP_IMAGE_NS_BUF_MMAP                   \
	MAP_REGION2(PLAT_QEMU_SP_IMAGE_NS_BUF_BASE, \
		    PLAT_QEMU_SP_IMAGE_NS_BUF_BASE, \
		    PLAT_QEMU_SP_IMAGE_NS_BUF_SIZE, \
		    MT_RW_DATA | MT_NS | MT_USER, PAGE_SIZE)
...
#define PLAT_QEMU_SP_IMAGE_HEAP_BASE \
	(PLAT_QEMU_SP_IMAGE_BASE + PLAT_QEMU_SP_IMAGE_SIZE)
#define PLAT_QEMU_SP_IMAGE_HEAP_SIZE ULL(0x800000)

#define PLAT_SP_IMAGE_STACK_BASE \
	(PLAT_QEMU_SP_IMAGE_HEAP_BASE + PLAT_QEMU_SP_IMAGE_HEAP_SIZE)
#define PLAT_SP_IMAGE_STACK_PCPU_SIZE ULL(0x10000)
#define QEMU_SP_IMAGE_STACK_TOTAL_SIZE \
	(PLATFORM_CORE_COUNT * PLAT_SP_IMAGE_STACK_PCPU_SIZE)

#define QEMU_SP_IMAGE_RW_MMAP                         \
	MAP_REGION2(PLAT_QEMU_SP_IMAGE_HEAP_BASE,     \
		    PLAT_QEMU_SP_IMAGE_HEAP_BASE,     \
		    (QEMU_SP_IMAGE_STACK_TOTAL_SIZE + \
		     PLAT_QEMU_SP_IMAGE_HEAP_SIZE),   \
		    MT_RW_DATA | MT_SECURE | MT_USER, PAGE_SIZE)
...
#define MAP_SECURE_VARSTORE                                                   \
	MAP_REGION_FLAT(QEMU_SECURE_VARSTORE_BASE, QEMU_SECURE_VARSTORE_SIZE, \
...
#define PLAT_QEMU_L0_GPT_BASE (PLAT_QEMU_L1_GPT_BASE - PLAT_QEMU_L0_GPT_SIZE)
...
#define PLAT_QEMU_L1_GPT_BASE \
	(BL_RAM_BASE + BL_RAM_SIZE - PLAT_QEMU_L1_GPT_SIZE)

#define RME_GPT_DRAM_BASE PLAT_QEMU_L0_GPT_BASE
#define RME_GPT_DRAM_SIZE (PLAT_QEMU_L1_GPT_SIZE + PLAT_QEMU_L0_GPT_SIZE)
...
#define MAP_GPT_L0_REGION                                               \
	MAP_REGION_FLAT(PLAT_QEMU_L0_GPT_BASE, (PLAT_QEMU_L0_GPT_SIZE), \
			MT_MEMORY | MT_RW | EL3_PAS)

#define MAP_GPT_L1_REGION                                             \
	MAP_REGION_FLAT(PLAT_QEMU_L1_GPT_BASE, PLAT_QEMU_L1_GPT_SIZE, \
			MT_MEMORY | MT_RW | EL3_PAS)
/*
 ...
 */
#define MAP_RMM_DRAM                                                      \
	MAP_REGION_FLAT(RMM_BASE, (PLAT_QEMU_RMM_SIZE + RMM_SHARED_SIZE), \
			MT_MEMORY | MT_RW | MT_REALM)

#define MAP_RMM_SHARED_MEM                                \
	MAP_REGION_FLAT(RMM_SHARED_BASE, RMM_SHARED_SIZE, \
			MT_MEMORY | MT_RW | MT_REALM)
