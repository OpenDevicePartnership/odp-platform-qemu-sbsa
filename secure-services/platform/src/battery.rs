...
impl From<BstRsp> for DirectMessagePayload {
    fn from(value: BstRsp) -> Self {
        ...
        DirectMessagePayload::from_iter(
            payload_regs
                .iter()
                .flat_map(|&reg| u32::to_le_bytes(reg).into_iter()),
        )
    }
}
...
mod tests {
    ...
    fn bat_req(cmd: u8) -> MsgSendDirectReq2 {
        MsgSendDirectReq2::new(
            ...
            0,
            Battery::UUID,
            DirectMessagePayload::from_iter(vec![cmd]),
        )
    }
    ...
    fn test_get_bix() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BIX))
            .unwrap();
    ...
    fn test_get_bst_from_state() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BST))
            .unwrap();
    ...
    fn test_get_psr() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_PSR))
            .unwrap();
    ...
    fn test_get_pif() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_PIF))
            .unwrap();
    ...
    fn test_get_bps() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BPS))
            .unwrap();
    ...
    fn test_get_btp_default() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BTP))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_bpt() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BPT))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_bpc() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BPC))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_bmc_default() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BMC))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_bmd() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BMD))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
        assert_eq!(val.value, 0);
    }
    ...
    fn test_get_bct() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BCT))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_btm() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BTM))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
    ...
    fn test_get_bms() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BMS))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
        assert_eq!(val.value, 0x1);
    }
    ...
    fn test_get_bma() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_BMA))
            .unwrap();
        let val = ValueRsp::from(resp.payload());
        assert_eq!(val.value, 0);
    }
    ...
    fn test_get_sta() {
        let mut bat = Battery::new();
        let resp = bat
            .ffa_msg_send_direct_req2(bat_req(EC_BAT_GET_STA))
            .unwrap();
